...
if (empty($_SESSION['email'])) {
   ...
   $result=mysqli_fetch_array($q);
        ...
        $sql = "SELECT * FROM events WHERE email = '$email' AND event = 'quiz2'";
		$r=mysqli_query($conn, $sql);
		$checkrow=mysqli_num_rows($r);
		if ($checkrow == 0) {
		   echo '<script type="text/javascript">alert("You have not registered for HydroChloroQuizone yet ")</script>';
    ...
    if(isset($_POST['submit'])){
	    ...
	    $query = "INSERT INTO quiz2 (email, question1, question2, question3, question4, question5) VALUES ('".$result['email']."', '".$_POST['question1']."',  '".$_POST['question2']."',  '".$_POST['question3']."',  '".$_POST['question4']."',  '".$_POST['question5']."')";
        ...
        <ul class="list-unstyled">
          ...
          <li class="active"><a href="#play" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Participate </a>
            <ul id="play" class="collapse list-unstyled ">
              ...
              <li class="active"><a href="quiz2.php">HydroxyChloroQuizone</a></li>  
      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">HydroChloroQuizone</h2>
          </div>
        </div>
