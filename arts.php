...
if (empty($_SESSION['email'])) {
   ...
   $result=mysqli_fetch_array($q);
        ...
        $sql = "SELECT * FROM events WHERE email = '$email' AND event = 'arts'";
		$r=mysqli_query($conn, $sql);
		$checkrow=mysqli_num_rows($r);
		if ($checkrow == 0) {
		   echo '<script type="text/javascript">alert("You have not registered for Artistas manos amigas yet ")</script>';
    ...
    if(isset($_POST['insert'])){
        ...
        if($_FILES['image']['size'] > 500000){
            ...
            $query = "INSERT INTO arts (email, filename) VALUES ('".$result['email']."', '".$newfilename."') ";
        ...
        <ul class="list-unstyled">
          ...
          <li class="active"><a href="#play" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Participate </a>
            <ul id="play" class="collapse list-unstyled ">
              ...
              <li class="active"><a href="arts.php">Artistas manos amigas</a></li>
      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Artistas manos amigas</h2>
          </div>
        </div>
